...
var Game = {
    ...
    init: function(){
        ...
        Game.walls.push(new Wall(100, 20));
        Game.walls.push(new Wall(100, 40));
        Game.walls.push(new Wall(100, 60));
        Game.walls.push(new Wall(100, 80));
        Game.walls.push(new Wall(100, 100));
        Game.walls.push(new Wall(100, 120));
        Game.walls.push(new Wall(20, 120));
        Game.walls.push(new Wall(40, 120));
        Game.walls.push(new Wall(60, 120));
        Game.walls.push(new Wall(80, 120));
        Game.walls.push(new Wall(20, 180));
        Game.walls.push(new Wall(40, 180));
        Game.walls.push(new Wall(60, 180));
        Game.walls.push(new Wall(80, 180));
        Game.walls.push(new Wall(100, 180));
        Game.walls.push(new Wall(100, 200));
        Game.walls.push(new Wall(100, 220));
        Game.walls.push(new Wall(100, 240));
        Game.walls.push(new Wall(100, 260));
        Game.walls.push(new Wall(100, 280));
        GameSession.init();
        if (GameSession.isCreator) {
